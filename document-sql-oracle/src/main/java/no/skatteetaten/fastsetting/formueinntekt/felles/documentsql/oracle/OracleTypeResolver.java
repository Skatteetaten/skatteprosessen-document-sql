...
public class OracleTypeResolver implements Function<Class<?>, String> {
    ...
    public OracleTypeResolver(boolean decimalsAsNumber) {
    ...
    public String apply(Class<?> type) {
        if (NUMERIC_TYPES.contains(type)) {
            ...
            return decimalsAsNumber ? "NUMBER" : "VARCHAR2(500)";
        } else {
